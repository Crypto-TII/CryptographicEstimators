...
class Crossbred(MQAlgorithm):
    def __init__(self, problem: MQProblem, **kwargs):
        ...
        The Crossbred is an algorithm to solve the MQ problem [JV18]. This algorithm consists of two steps:
        ...
        Note:
            ...
            given in [Dua20], which are given either for q=2 or generic fields.
