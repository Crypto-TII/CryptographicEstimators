...
from ..dummy_algorithm import PSAlgorithm
from ..dummy_problem import PSProblem
from ...base_algorithm import optimal_parameter
from math import log2


class PSAlgorithm1(PSAlgorithm):
    """
    Construct an instance of PSAlgorithm1 estimator
    ...
    EXAMPLES::
        ...
        sage: from cryptographic_estimators.PSEstimator.PSAlgorithms.dummy_algorithm1 import PSAlgorithm1
        sage: from cryptographic_estimators.PSEstimator.dummy_problem import PSProblem
        sage: E = PSAlgorithm1(PSProblem(100, 50))
        sage: E
